 ...
 * @since 1.0
 */
function div_get_image_id($num = 0) {
  global $post;
...
add_filter('wp_get_attachment_image_attributes', 'div_filter_attachment_image_attributes', 10, 2);
/**
 ...
 * @since 1.0
 */
function div_filter_attachment_image_attributes($attr, $attachment) {
