    ...
    register_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                ...
                'type' => 'textarea',
                'instructions' => 'Enter your GA tracking code <a href="https://support.google.com/analytics/answer/1032385?hl=en" target="_blank">Where do I get this?</a>',
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
                        array (
    ...
    register_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                ...
                'name' => 'load_bxslider',
                'type' => 'radio',
                'instructions' => 'Load BXSlider in header or footer?',
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
                        array (
            ...
            array (
                'key' => 'field_n18e91fvw38n7',
                'label' => 'Include HTML5 Shiv',
                'name' => 'include_html5_shiv',
                'type' => 'true_false',
                'instructions' => 'Do you want to include <a href="https://code.google.com/p/html5shiv/" target="_blank">HTML5 Shiv</a> <em>(v3.7.0 for IE8 & below)</em>',
                'required' => 0,
                'message' => '',
                'default_value' => 0,
            ),
